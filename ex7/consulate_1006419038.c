...
// This is a linked list Ticket for either the stack or the queue
...
bool enqueue(Data *data, char *name)
{
	...
	Ticket* temp = ( Ticket*)calloc(1,sizeof( Ticket));
...
bool push(Data *data, char *name)
{
	...
	Ticket* temp = NULL;
	temp = ( Ticket*)calloc(1,sizeof( Ticket));
...
int main()
{
    ...
    const double RATE = 0.9;     // Change this to rationals between 0.1 and 0.9 to test.
